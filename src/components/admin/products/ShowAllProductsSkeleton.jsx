    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6  mt-7">
        {Array.from({ length: 6 }).map((_, index) => (
          <div
            key={index}
            className="rounded-4xl border border-amazon-border bg-amazon-surface w-full overflow-hidden animate-pulse"
          >
...
export default ShowAllProductsSkeleton;
