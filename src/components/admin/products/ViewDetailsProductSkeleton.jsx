const ViewDetailsProductSkeleton = () => {
  return (
    <div className="p-6">
      {/* header */}
      <div className="mb-6">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-3">
            {[1, 2, 3, 4].map((item) => (
              <div key={item} className="shimmer h-20 rounded-xl"></div>
            ))}
          </div>
          {/* Slider */}
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl bg-amazon-surface p-7 shadow">
            ...
            <div className="mt-5 flex gap-3">
              {[1, 2, 3].map((item) => (
                <div key={item} className="shimmer h-8 w-20 rounded-full"></div>
              ))}
            </div>
          </div>
          {/* Category */}
...
export default ViewDetailsProductSkeleton;
