...
import ViewDetailsProductSkeleton from "./ViewDetailsProductSkeleton";
...
const ViewDetailsProduct = () => {
  ...
  if (!product) {
    return <ViewDetailsProductSkeleton />;
  }
  return (
    <div className=" p-4 lg:p-6 ">
      ...
      <div className="w-full max-w-5xl rounded-3xl p-5  bg-amazon-navy    ">
        <button
          onClick={() => navigate(-1)}
          className="flex mb-4 gap-2 items-center text-white/80 
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-amazon-surface rounded-3xl p-8 shadow">
            ...
            <p className="text-sm text-amazon-textDark mt-4">
              {product.description}
            </p>
          </div>{" "}
          {/* Overview */}
