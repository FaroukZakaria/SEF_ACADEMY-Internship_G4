...
function TopProductsCard() {
  ...
  if (loading) {
    return <TopProductsCardSkeleton />;
  }
  return (
    <div className="rounded-3xl border border-amazon-border bg-amazon-surface/90 p-6 shadow-xl">
      <p className="text-sm uppercase tracking-[0.35em] text-amazon-orange">
        Top products
      </p>
      <h3 className="mt-2 text-xl font-semibold text-amazon-textDark">
        Best sellers
      </h3>
      <div className="mt-4 space-y-3">
        {loading && <p className="text-sm text-amazon-textLight">Loading...</p>}
